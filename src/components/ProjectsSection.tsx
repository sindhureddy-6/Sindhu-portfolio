          ...
          <SwiperSlide>
            <div className={styles.projectcard}>
             <div><h1>Edu-World</h1></div> 
              <div><p>The Learning Management System (LMS) is an online platform designed to facilitate learning interactions between educators and students.[credentials:User&password:abcde]</p></div>
              <div><p>Skills-HTML, CSS, JavaScript, Node.js, PostgresSQl, Express</p></div>
